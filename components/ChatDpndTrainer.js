...
export default class ChatDpndTrainer extends Component {
    state = {
        messages: [],
        traineeMessages: [],
        trainerMessages: []
    ...
    async componentDidMount() {
        ...
        await axios.get(api + "/MessageGetFromTrainee/" + userId + "/" + traineeId).then(resp => {
            let items = (resp.data);
        ...
        await axios.get(api + "/MessageGetFromTrainer/" + userId + "/" + traineeId).then(resp => {
            let items = (resp.data);
            items.filter(function (item) {
